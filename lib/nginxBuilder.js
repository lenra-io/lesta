...
export default async function nginxBuilder(configuration, managers) {
    ...
    // await loadTranslations(configuration.i18nDir, configuration.languages);
    const options = { paths, i18next };
 ...
 * @property {Object.<string, string[]>} additionalLocationConfigs Additional configurations for specific locations
 */
