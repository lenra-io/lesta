...
export default function pugPageRenderer(configuration, page, language, renderOptions) {
    return new Promise((resolve, reject) => {
        ...
        const options = mergeDeep({ filename: sourceFile }, renderOptions, {
            currentPage: { path: page.path, href: page.href, basicPath }, language, languages: configuration.languages, fileExists: existsSync, t: i18next.t
        });
